...
// Schedule LIST 702 remains the canonical cross-client pagination operation.
...
export const MSG_SCHEDULE_CREATE_BATCH = 706;
export const MSG_SCHEDULE_LIST_V2 = 707;
